    ...
    gmail: [
      ...
      },
      {
        ...
        options: [
          ...
          { name: "Get", value: "get", displayOptions: { show: { resource: ["message"] } } },
          { name: "Get Many", value: "getAll", displayOptions: { show: { resource: ["message", "label"] } } },
          { name: "Reply", value: "reply", displayOptions: { show: { resource: ["message"] } } },
          { name: "Add Label", value: "addLabels", displayOptions: { show: { resource: ["message"] } } },
          { name: "Remove Label", value: "removeLabels", displayOptions: { show: { resource: ["message"] } } },
          ...
          { name: "Delete", value: "delete", displayOptions: { show: { resource: ["message"] } } },
          { name: "Create", value: "create", displayOptions: { show: { resource: ["label"] } } },
        ],
      },
      {
        name: "to",
      ...
      },
      {
        ...
        type: "string",
        default: "data",
        description: "WorkflowItem binary property to attach. Filesystem paths are not accepted.",
        displayOptions: { show: { resource: ["message"], operation: ["send", "reply"] } },
      },
      {
        name: "messageId",
      ...
      },
      {
        ...
        type: "boolean",
        default: true,
        description: "Return message id, thread, and headers. Turn off to include the message body.",
      ...
      },
      {
        ...
        type: "boolean",
        default: false,
        description: "Page through Gmail results, up to the workflow safety cap.",
      ...
      },
      {
        ...
        type: "string",
        expression: true,
        description: "Gmail search syntax, for example from:alice subject:invoice is:unread.",
      ...
      },
      {
        ...
        displayOptions: {
          showAny: [
            { resource: ["message"], operation: ["addLabels", "removeLabels"] },
