...
require("./smoke-workflow-error-11b").registerPart11BTests({
  check,
  section,
  assert,
});
...
require("./smoke-workflow-ai-12c").registerPart12CTests({
  check,
  section,
  assert,
});
...
require("./smoke-workflow-13b").registerPart13BTests({
  check,
  section,
  assert,
});
require("./smoke-workflow-14a").registerPart14ATests({
  check,
  section,
  assert,
});
...
require("./smoke-workflow-14c").registerPart14CTests({
  check,
  section,
  assert,
});
require("./smoke-workflow-14d").registerPart14DTests({
  check,
  section,
  assert,
});
...
require("./smoke-workflow-14d54").registerPart14D54Tests({
  check,
  section,
  assert,
});
require("./smoke-workflow-14d54a").registerPart14D54ATests({
  check,
  section,
  assert,
});
require("./smoke-workflow-14d54b").registerPart14D54BTests({
  check,
  section,
  assert,
});
require("./smoke-workflow-14d55a").registerPart14D55ATests({
  check,
  section,
  assert,
});
...
require("./smoke-workflow-14d55c3").registerPart14D55C3Tests({
  check,
  section,
  assert,
});
