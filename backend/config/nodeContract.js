...
const NODE_ENGINE_CONTRACTS = {
  ...
  googleAnalytics: { cardinality: "1-to-N", pairedItemPolicy: "fanOut", mergeInputs: 1, isSideEffecting: true },
  gmail: { cardinality: "N-to-N", pairedItemPolicy: "identity1to1", mergeInputs: 1, isSideEffecting: true },
  gmailTrigger: { cardinality: "0-to-1", pairedItemPolicy: "none", isTrigger: true, mergeInputs: 0, isStateful: true },
  googleSheets: { cardinality: "N-to-N", pairedItemPolicy: "identity1to1", mergeInputs: 1, isSideEffecting: true },
  aiGenerate: { cardinality: "N-to-N", pairedItemPolicy: "identity1to1", mergeInputs: 1, isSideEffecting: true },
  xlsxBuilder: { cardinality: "N-to-1", pairedItemPolicy: "fanIn", mergeInputs: 1 },
